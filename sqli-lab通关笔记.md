...
![image-20210510214933062](sqli-lab通关笔记.assets/image-20210510214933062.png)
...
*   获取列数，4列报错，3列正常显示，则说明显示SQL语句显示3列信息
    ...
    <img src="sqli-lab通关笔记.assets/image-20210510215437509.png" alt="image-20210510215437509" data-size="original">
* 获取显示的列 **注意，单引号前面的1要改成-1，因为他不能显示信息，后面的语句才能显示**

![image-20210510215708911](sqli-lab通关笔记.assets/image-20210510215708911.png)

显示`2,3`，下面我们就在2,3列上修改sql函数

*   获取SQL数据库信息

    <img src="sqli-lab通关笔记.assets/image-20210510215854464.png" alt="image-20210510215854464" data-size="original">
...
枚举所有的数据库信息![image-20210510220708753](sqli-lab通关笔记.assets/image-20210510220708753.png)

枚举数据库所有表名

![image-20210510220948625](sqli-lab通关笔记.assets/image-20210510220948625.png)

枚举users表中的所有列名

![image-20210510221142238](sqli-lab通关笔记.assets/image-20210510221142238.png)

枚举出所有的users表中的username和password，破解成功

![image-20210510221810545](sqli-lab通关笔记.assets/image-20210510221810545.png)

## 第二关

输入`'`单引号报语法错误，然后输入注释符之后报错并没有消失，根据报错信息可以推断出这个SQL查询语句应该是数字型的。

![image-20210511101332144](sqli-lab通关笔记.assets/image-20210511101332144.png)

于是开始针对数字型注入开始测试，成功得到信息

![image-20210511101454919](sqli-lab通关笔记.assets/image-20210511101454919.png)
...
![image-20210511140358241](sqli-lab通关笔记.assets/image-20210511140358241.png)

![image-20210511140524020](sqli-lab通关笔记.assets/image-20210511140524020.png)

接下来就是判断列数--》3列

以下步骤和前两关一样，不在赘述

![image-20210511140815064](sqli-lab通关笔记.assets/image-20210511140815064.png)
...
![image-20210511141636612](sqli-lab通关笔记.assets/image-20210511141636612.png)

显示`database()、version()、users()`

利用information\_schema数据库爆出想要的数据表信息，不再赘述

![image-20210511141936063](sqli-lab通关笔记.assets/image-20210511141936063.png)

## 第五关

这一关是字符型注入，和第一关一样，但是这一关并不显示数据信息，只显示You are in……

![image-20210511142142909](sqli-lab通关笔记.assets/image-20210511142142909.png)
...
接下来利用三种语句的其中之一利用information\_schema库进行注入即可

![image-20210511145507931](sqli-lab通关笔记.assets/image-20210511145507931.png)
...
>
>     and updatexml(1,concat(0x7e,mid((select group\_concat(schema\_name) from information\_schema.schemata),1,31),0x7e),1) %23
>
>     and updatexml(1,concat(0x7e,mid((select group\_concat(schema\_name) from information\_schema.schemata),32,31),0x7e),1) %23
...
![image-20210512221642700](sqli-lab通关笔记.assets/image-20210512221642700.png)

于是开始下一波的操作，查询列数，回显数据库的相关信息。很明显这一关他不回显数据库中的正确信息，如果语法正确他只显示You are in……，看来只能用报错注入语句试试了。

![image-20210512222329424](sqli-lab通关笔记.assets/image-20210512222329424.png)
...
![image-20210513212407123](sqli-lab通关笔记.assets/image-20210513212407123.png)
...
![image-20210513213648272](sqli-lab通关笔记.assets/image-20210513213648272.png)
...
上传成功，这里注意会出现 `**mysql 报错The MySQL server is running with the --secure-file-priv option so it cannot execute**`，需要在my.ini修改secure\_file\_priv='into 文件的地址'

![image-20210513220146623](sqli-lab通关笔记.assets/image-20210513220146623.png)

然后用蚁剑成功连接服务器

![image-20210513220212340](sqli-lab通关笔记.assets/image-20210513220212340.png)
...
[更多脚本代码（get时间盲注、post布尔盲注、post时间盲注）](https://blog.csdn.net/south\_layout/article/details/105964155)

成功爆出用户名和密码

![image-20210517203014403](sqli-lab通关笔记.assets/image-20210517203014403.png)

## 第九关

这一关无论输入什么特殊字符，出现语法错误和正常SQL语句返回的页面都是一样的，看看源码显示，限制了正确结果与错误结果返回的页面一致，看来不能使用布尔盲注了，要使用时间盲注。

![image-20210517203434270](sqli-lab通关笔记.assets/image-20210517203434270.png)
...
![image-20210517211032100](sqli-lab通关笔记.assets/image-20210517211032100.png)
...
![image-20210517212451407](sqli-lab通关笔记.assets/image-20210517212451407.png)

准确率还是很差

## 第十一关

![image-20210519114118567](sqli-lab通关笔记.assets/image-20210519114118567.png)
...
![image-20210519114246873](sqli-lab通关笔记.assets/image-20210519114246873.png)
...
![image-20210519114424756](sqli-lab通关笔记.assets/image-20210519114424756.png)
...
![image-20210519114644033](sqli-lab通关笔记.assets/image-20210519114644033.png)
...
![image-20210519115045872](sqli-lab通关笔记.assets/image-20210519115045872.png)

成功获取想得到的数据

## 第十二关

![image-20210519122506609](sqli-lab通关笔记.assets/image-20210519122506609.png)
...
![image-20210519123004345](sqli-lab通关笔记.assets/image-20210519123004345.png)
...
![image-20210519123224721](sqli-lab通关笔记.assets/image-20210519123224721.png)
...
![image-20210519123437363](sqli-lab通关笔记.assets/image-20210519123437363.png)
...
![image-20210519123759380](sqli-lab通关笔记.assets/image-20210519123759380.png)

获取hadsky.pk\_user表中字段的信息，payload：
...
![image-20210519124015764](sqli-lab通关笔记.assets/image-20210519124015764.png)

获取hadsky.pk\_user表中的username和password信息，payload：

```
uname=aaa%22)union+select+database(),group_concat(username,0x7e,password)+from+hadsky.pk_user#&passwd=aaa&submit=Submit
```

![image-20210519124320254](sqli-lab通关笔记.assets/image-20210519124320254.png)
...
![image-20210519125512762](sqli-lab通关笔记.assets/image-20210519125512762.png)
...
![image-20210519130002929](sqli-lab通关笔记.assets/image-20210519130002929.png)
...
![image-20210519130448745](sqli-lab通关笔记.assets/image-20210519130448745.png)
...
![image-20210519130636730](sqli-lab通关笔记.assets/image-20210519130636730.png)
...
![image-20210519181903184](sqli-lab通关笔记.assets/image-20210519181903184.png)
...
![image-20210521113903090](sqli-lab通关笔记.assets/image-20210521113903090.png)

但是使用 `union select` 无回显信息，报错注入成功显示信息

![image-20210521114227279](sqli-lab通关笔记.assets/image-20210521114227279.png)
...
![image-20210521130413879](sqli-lab通关笔记.assets/image-20210521130413879.png)
...
![image-20210521130702574](sqli-lab通关笔记.assets/image-20210521130702574.png)
...
![image-20210521130823024](sqli-lab通关笔记.assets/image-20210521130823024.png)
...
![image-20210521130942406](sqli-lab通关笔记.assets/image-20210521130942406.png)

内容没有显示完全，可以使用left()或者right()查看剩余的内容

## 第十五关

![image-20210521131658328](sqli-lab通关笔记.assets/image-20210521131658328.png)
...
![image-20210521132216267](sqli-lab通关笔记.assets/image-20210521132216267.png)
...
![image-20210521192440701](sqli-lab通关笔记.assets/image-20210521192440701.png)
...
![image-20210527163352492](sqli-lab通关笔记.assets/image-20210527163352492.png)
...
![image-20210527170429861](sqli-lab通关笔记.assets/image-20210527170429861.png)

## 第十七关

![image-20210527170508219](sqli-lab通关笔记.assets/image-20210527170508219.png)
...
![image-20210527173059828](sqli-lab通关笔记.assets/image-20210527173059828.png)
...
![image-20210527173514622](sqli-lab通关笔记.assets/image-20210527173514622.png)
...
![image-20210527174337740](sqli-lab通关笔记.assets/image-20210527174337740.png)

从users表中查询password信息，报错了

![image-20210527175607769](sqli-lab通关笔记.assets/image-20210527175607769.png)

![img](sqli-lab通关笔记.assets/1675852-20190526103007361-1980441638.png)
...
![image-20210527180352717](sqli-lab通关笔记.assets/image-20210527180352717.png)

## 第十八关

![image-20210602192059992](sqli-lab通关笔记.assets/image-20210602192059992.png)

数据包请求头注入，抓包测试一下

这一关的代码：

![image-20210602193555386](sqli-lab通关笔记.assets/image-20210602193555386.png)

由于select语句做了很强的过滤，所以他并不存在注入，所以咱们只能从insert语句下手了。但是insert成功执行的前提就是需要成功输入正确的用户名和密码，才能执行到insert语句。

![image-20210602194023706](sqli-lab通关笔记.assets/image-20210602194023706.png)

接下来就是尝试在UA字段或者XXF字段注入SQL代码

![image-20210602194220760](sqli-lab通关笔记.assets/image-20210602194220760.png)

根据上述图片咱们发现XXF字段对ip并没有什么影响，所以尝试在ua字段中进行注入。在1后面加上单引号，报了语法错误，很明显此关卡是单引号字符注入。

![image-20210602194354165](sqli-lab通关笔记.assets/image-20210602194354165.png)
...
![image-20210602195344190](sqli-lab通关笔记.assets/image-20210602195344190.png)
...
![image-20210602200726586](sqli-lab通关笔记.assets/image-20210602200726586.png)
...
![image-20210602201329697](sqli-lab通关笔记.assets/image-20210602201329697.png)
...
![image-20210602201505454](sqli-lab通关笔记.assets/image-20210602201505454.png)
...
![image-20210602201926359](sqli-lab通关笔记.assets/image-20210602201926359.png)

成功获得users表中的数据

## 第十九关

![image-20210602202311752](sqli-lab通关笔记.assets/image-20210602202311752.png)

![image-20210602202452936](sqli-lab通关笔记.assets/image-20210602202452936.png)

这个关卡跟上一个关卡一样，都需要输入正确的username和password，才能进行insert注入。本关卡是对Referer字段字段进行注入：

![image-20210602202656722](sqli-lab通关笔记.assets/image-20210602202656722.png)

输入单引号提示有语法错误，本关卡是单引号字符型注入。但是并没有回显insert注入的字段有几个，咱们只能猜测了。

一个注入字段报错

![image-20210602203036348](sqli-lab通关笔记.assets/image-20210602203036348.png)

两个注入字段成功

![image-20210602203119236](sqli-lab通关笔记.assets/image-20210602203119236.png)
...
![image-20210602203720724](sqli-lab通关笔记.assets/image-20210602203720724.png)
...
![image-20210602204133315](sqli-lab通关笔记.assets/image-20210602204133315.png)

![image-20210602204303568](sqli-lab通关笔记.assets/image-20210602204303568.png)

![image-20210602204406153](sqli-lab通关笔记.assets/image-20210602204406153.png)
...
![image-20210602204525176](sqli-lab通关笔记.assets/image-20210602204525176.png)
...
![image-20210602204640784](sqli-lab通关笔记.assets/image-20210602204640784.png)
...
![image-20210602204815178](sqli-lab通关笔记.assets/image-20210602204815178.png)

![image-20210602204911776](sqli-lab通关笔记.assets/image-20210602204911776.png)

![image-20210602204926621](sqli-lab通关笔记.assets/image-20210602204926621.png)

获取了全部的users表中的信息

## 第二十关

![image-20210604200830978](sqli-lab通关笔记.assets/image-20210604200830978.png)

在请求头字段加上cookie的uname字段，会回显一些数据信息，试试cookie是否存在注入漏洞。

经测试本关卡是字符型注入，union select

![image-20210604201125396](sqli-lab通关笔记.assets/image-20210604201125396.png)

获取所有数据库名称：

![image-20210604201254604](sqli-lab通关笔记.assets/image-20210604201254604.png)

获取security数据库中的所有表名：

![image-20210604201554304](sqli-lab通关笔记.assets/image-20210604201554304.png)

获取security.users表中的字段：

![image-20210604201728550](sqli-lab通关笔记.assets/image-20210604201728550.png)

获取security.users表中的所有数据

![image-20210604201855487](sqli-lab通关笔记.assets/image-20210604201855487.png)

## 第二十一关

下面是21关的源码

![image-20210604202656519](sqli-lab通关笔记.assets/image-20210604202656519.png)

他把cookie进行了base64解码，说明我们需要提前进行base64编码再修改cookie值，而且单引号加括号的注入方式

base64编码：

![image-20210604203133165](sqli-lab通关笔记.assets/image-20210604203133165.png)

会显得数据：

![image-20210604203201799](sqli-lab通关笔记.assets/image-20210604203201799.png)

接下来就是获取数据库的信息了，多一道步骤就是需要先base64编码，在传输到cooKie中

获取所有的数据库名称：

![image-20210604203410776](sqli-lab通关笔记.assets/image-20210604203410776.png)

![image-20210604203423534](sqli-lab通关笔记.assets/image-20210604203423534.png)

获取security数据中的所有表名称：

![image-20210604203549704](sqli-lab通关笔记.assets/image-20210604203549704.png)

![image-20210604203541713](sqli-lab通关笔记.assets/image-20210604203541713.png)

获取security.users表中的字段：

![image-20210604203653839](sqli-lab通关笔记.assets/image-20210604203653839.png)

![image-20210604203714873](sqli-lab通关笔记.assets/image-20210604203714873.png)

获取security.users表中的所有数据：

![image-20210604203813712](sqli-lab通关笔记.assets/image-20210604203813712.png)

![image-20210604203833871](sqli-lab通关笔记.assets/image-20210604203833871.png)
